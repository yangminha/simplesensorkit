...
>> The distance sensor returns false when the detected object is outside its approximate measurement range of 700 cm (270 in). It returns true when an object is within range and a valid distance measurement is available.
